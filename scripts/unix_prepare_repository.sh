...
./contrib/directory_iterator/scripts/unix_prepare_repository.sh
./contrib/qtutils/scripts/unix_prepare_repository.sh
./contrib/system/scripts/unix_prepare_repository.sh
